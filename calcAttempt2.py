...
#create the base for using tkinter for the GUI  
root = Tk()
...
class Calc():
    ...
    #function to display and interpret number being inputted
    def numberEnter(self, num):
        self.result=False
        #grabs first number from display
        firstnum=txtDisplay.get()
        #registers number being passed as the second number
        secondnum=str(num)
        if self.input_value:
    ...
    #function to show the current input
    def display(self, value):
        txtDisplay.delete(0, END)
        txtDisplay.insert(0, value)
  
    #does the basic operators
    ...
    #allows for operator use other than +/-/*//
...
#        self.display(self.current)
    ...
    def arccos(self):
        self.result = False
        self.current = np.arccos(math.radians(float(txtDisplay.get())))
        self.display(self.current)
    #solves tan
    def tan(self):
        self.result = False
    ...
    def arctan(self):
        self.result = False
        self.current = np.arctan(math.radians(float(txtDisplay.get())))
        self.display(self.current)
    #solves sin
    def sin(self):
        self.result = False
    ...
    def arcsin(self):
        self.result = False
        self.current =np.arcsin(math.radians(float(txtDisplay.get())))
        self.display(self.current)
    #solves log
    def log(self):
        self.result = False
...
#               ).grid(row=2, column= 4, pady = 1)
 # 
btnArccos = Button(calc, text="arccos",width=6,
                 height=2,bg='black',fg='white',
                 font=('Helvetica',20,'bold'),
                 bd=4,command=added_value.arccos
                ).grid(row=2, column= 5, pady = 1)
 # 
btnarctan = Button(calc, text="arctan",width=6, 
                 height=2,bg='black',fg='white',
                 font=('Helvetica',20,'bold'),
                 bd=4,command=added_value.arctan
                ).grid(row=2, column= 6, pady = 1)
 # 
btnarcsin = Button(calc, text="arcsin",width=6, 
                 height=2,bg='black',fg='white',
                 font=('Helvetica',20,'bold'),
                 bd=4,command=added_value.arcsin
